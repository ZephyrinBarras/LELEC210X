...
output_array = load_array("./LimeSDR-Mini_lms7_lelec210x/ip/packet_presence_detection/testbench/mentor/output_fpga.txt", nbit, qbit)
input_array  = load_array("./LimeSDR-Mini_lms7_lelec210x/ip/packet_presence_detection/testbench/mentor/input_fpga.txt", nbit, qbit)
